...
const users: User[] = [
  ...
  { name: "Aroha Ngata", username: "aroha.ngata", email: "aroha.ngata@wesley.nz", role: "nurse", scope: "All residents", buildingId: "wesley", status: "Active", last: "12m ago", initials: "AN", color: "#6E875E" },
  { name: "David Cho", username: "david.cho", email: "david.cho@wesley.nz", role: "nurse", scope: "All residents", buildingId: "wesley", status: "Active", last: "1h ago", initials: "DC", color: "#8a6ba3" },
  { name: "Mere Solomon", username: "mere.solomon", email: "mere.solomon@wesley.nz", role: "carer", scope: "All residents", buildingId: "wesley", status: "Active", last: "25m ago", initials: "MS", color: "#b06a5a" },
  { name: "Tomasi Fifita", username: "tomasi.fifita", email: "tomasi.fifita@wesley.nz", role: "carer", scope: "All residents", buildingId: "wesley", status: "Active", last: "Yesterday", initials: "TF", color: "#5b8f9a" },
  ...
  { name: "Priya Nair", username: "priya.nair", email: "priya.nair@wesley.nz", role: "carer", scope: "All residents", buildingId: "wesley", status: "Invited", last: "Pending", initials: "PN", color: "#7e9b6a" },
  { name: "David Whitcombe", username: "d.whitcombe", email: "d.whitcombe@gmail.com", role: "family", scope: "Peggy W. · Room 12", buildingId: "wesley", status: "Active", last: "2d ago", initials: "DW", color: "#6e879e" },
  { name: "Katherine Ruatoto", username: "k.ruatoto", email: "k.ruatoto@gmail.com", role: "family", scope: "Joan F. · Room 15", buildingId: "wesley", status: "Suspended", last: "2 wk ago", initials: "KR", color: "#9a7b4f" },
];
